...
exports.genre_update_post = [
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            res.render('genre_form', { title: 'Create Genre', name: req.body.name, errors: errors.array() });
            return;
        }
        else {
            // Data from form is valid.

            Genre.findByIdAndUpdate(req.params.id, {name: req.body.name}, {}, function (err, thegenre) {
                if (err) { return next(err); }
